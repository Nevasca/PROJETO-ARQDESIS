...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#txtNumeroCartao').mask('9999 9999 9999 9999');
		$("#txtValidadeCartao").mask("99/9999");
		$("#txtCodSeguranca").mask("999");
	});
...
<body>
	...
	<div class="container">
		<div class="col-md-8">
			...
			<form name="pagamentoCredito" class="form-horizontal" method="post"
				onsubmit="return validarPagamento('C');"
				action="pagamentoCredito.do">
				...
				<div class="form-group">
					<label for="valorPagamento">Valor Pagamento: <span
						...
						value="<%out.print(valorAPagar);%>" class="form-control" disabled />
					<span class="erro-form" id="erroValorPagamento"></span>
				...
				<div class="form-group">
					<label for="validadeCartao">Validade Cartão: <span
						class="campo-obrigatorio">*</span>
					</label> <input id="txtValidadeCartao" name="txtValidadeCartao" type="text"
						value="" class="form-control" /> <span class="erro-form"
						id="erroValidadeCartao"></span>

				</div>
				<div class="form-group">
					<label for="lblOperadoraCartao">Operadora Crédito: <span
						class="campo-obrigatorio">*</span>
					</label> <select name="cbOperadoraCartao" size="1" class="form-control">
						<option value="SELECIONE:">SELECIONE:</option>
						<option value="MASTERCARD">MASTERCARD</option>
						<option value="VISA">VISA</option>
						<option value="AMERICAN EXPRESS">AMERICAN EXPRESS</option>
						<option value="HIPERCARD">HIPERCARD</option>
					</select> <span class="erro-form" id="erroOperadoraCartao"></span>
				</div>
				<div class="form-group">
					<label for="numCartao">Número Cartão: <span
						class="campo-obrigatorio">*</span>
					</label> <input id="txtNumeroCartao" name="txtNumeroCartao" type="text"
						value="" class="form-control" /> <span class="erro-form"
						id="erroNumeroCartao"></span>
				</div>
				<div class="form-group">
					<label for="codSeguranca">Código Segurança: <span
						class="campo-obrigatorio">*</span>
					</label> <input id="txtCodSeguranca" name="txtCodSeguranca" type="password"
						value="" class="form-control" /> <span class="erro-form"
