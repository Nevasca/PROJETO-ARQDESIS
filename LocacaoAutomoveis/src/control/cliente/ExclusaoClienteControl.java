 ...
 */
@WebServlet("/cliente/exclusao.do")
public class ExclusaoClienteControl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExclusaoClienteControl() {
        super();
...
request.setCharacterEncoding("UTF-8");
		...
		RequestDispatcher view = request.getRequestDispatcher("/cliente/exclusao-sucesso.jsp");
